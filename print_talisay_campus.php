    ...
    <div class="report-title" style = "margin:10px;"><br/>
      <div class="print-logo">
        ...
        <center><strong>ĐẠI HỌC BÁCH KHOA HÀ NỘI</strong></center>
            ...
            <br>
            <center>BỘ MÔN CÔNG NGHỆ PHẦN MỀM</center>
      ...
      <table id="example" class="stripe order-table" cellspacing="0">
        <thead>
                                ...
                                <tbody>
                                  ...
                                  <?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM tbl_personnel LEFT JOIN tbl_gass_rank ON tbl_personnel.gass_id = tbl_gass_rank.gass_id LEFT JOIN tbl_academic_rank ON tbl_personnel.rank_id = tbl_academic_rank.rank_id WHERE tbl_personnel.per_campus='Công nghệ phần mềm'  ORDER BY per_id ASC");
                                    $display->execute();
